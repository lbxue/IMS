...
if (!window['google']['loader']) {
    ...
    google.loader.ClientLocation = {
        "latitude": 22.533,
        "longitude": 114.133,
        "address": {"city": "New Territories", "region": "Hong Kong", "country": "Hong Kong", "country_code": "HK"}
    };
    google.loader.AdditionalParams = '';
    (function () {
        var d = void 0, g = !0, h = null, j = !1, k = encodeURIComponent, l = window, m = document;

        function n(a, b) {
            return a.load = b
        }

        var p = "push", q = "replace", r = "charAt", t = "indexOf", u = "ServiceBase", v = "name", w = "getTime", x = "length", y = "prototype", z = "setTimeout", A = "loader", B = "substring", C = "join", D = "toLowerCase";
        ...
        n(google, function (a, b, c) {
            ...
            var f = a, c = c || {};
            if (a instanceof Array || a && "object" == typeof a && "function" == typeof a[C] && "function" == typeof a.reverse)for (var i = 0; i < a[x]; i++)e(a[i]); else e(a);
            if (a = N[":" + f]) {
        ...
        function Q(a, b, c) {
            if (a.addEventListener)a.addEventListener(b, c, j); else if (a.attachEvent)a.attachEvent("on" + b, c); else {
                var e = a["on" + b];
                a["on" + b] = e != h ? aa([c, e]) : c
            }
        }
        ...
        L("google.loader.domReady", google[A].N);
        var ba = {loaded: g, complete: g};
        ...
        L("google.loader.createGuidArg_", google[A].M);
        J("google_exportSymbol", J);
        J("google_exportProperty", K);
        google[A].b = {};
        L("google.loader.themes", google[A].b);
        google[A].b.H = "//www.google.com/cse/style/look/bubblegum.css";
        M(google[A].b, "BUBBLEGUM", google[A].b.H);
        google[A].b.J = "//www.google.com/cse/style/look/greensky.css";
        M(google[A].b, "GREENSKY", google[A].b.J);
        google[A].b.I = "//www.google.com/cse/style/look/espresso.css";
        M(google[A].b, "ESPRESSO", google[A].b.I);
        google[A].b.L = "//www.google.com/cse/style/look/shiny.css";
        M(google[A].b, "SHINY", google[A].b.L);
        google[A].b.K = "//www.google.com/cse/style/look/minimalist.css";
        M(google[A].b, "MINIMALIST", google[A].b.K);
        function V(a) {
            this.a = a;
            this.o = [];
            this.n = {};
        ...
        V[y].g = function (a, b) {
            ...
            if (!this.j) {
                google[this.a] && google[this.a].JSHash && (c += "&sig=" + k(google[this.a].JSHash));
                var e = [], f;
        ...
        V[y].t = function (a) {
            ...
            a && (b = a.packages);
            var c = h;
            if (b)if ("string" == typeof b)c = [a.packages]; else if (b[x]) {
                c = [];
        ...
        n(V[y], function (a, b) {
            ...
            for (var i = [], o = c[x] - 1; 0 <= o; o--) {
                var s = c[o];
                e && f.A(s);
                if (this.e[":" + s])c.splice(o, 1), e && this.f[":" + s][p](f); else i[p](s)
            }
            if (c[x]) {
                b && b.packages && (b.packages = c.sort()[C](","));
                for (o = 0; o < i[x]; o++)s = i[o], this.f[":" + s] = [], e && this.f[":" + s][p](f);
                if (!b && O[":" + this.a] != h && O[":" + this.a].versions[":" + a] != h && !google[A].AdditionalParams && this.j) {
                    c = O[":" + this.a];
                    google[this.a] = google[this.a] || {};
                    for (var S in c.properties)S && ":" ==
                    S[r](0) && (google[this.a][S[B](1)] = c.properties[S]);
        ...
        V[y].l = function (a) {
            -1 != this.c && (ca("al_" + this.a, "jl." + ((new Date)[w]() - this.c), g), this.c = -1);
            this.o = this.o.concat(a.components);
            google[A][this.a] || (google[A][this.a] = {});
            google[A][this.a].packages = this.o.slice(0);
        ...
        U[y].g = function (a, b) {
            if (!this.i.versions[":" + a]) {
                ...
                if (!this.i.versions[":" + a])throw I("Module: '" + this.a + "' with version '" + a + "' not found!");
            }
            return google[A].GoogleApisBase + "/libs/" + this.a + "/" + a + "/" + this.i.versions[":" + a][b && b.uncompressed ? "uncompressed" : "compressed"]
        };
        U[y].s = function () {
            return j
        };
        var da = j, Z = [], ea = (new Date)[w](), ca = function (a, b, c) {
    ...
    google.loader.rfm({
        ":search": {
            "versions": {":1": "1", ":1.0": "1"},
            "path": "/api/search/1.0/fc20d480e134e0dfc60ba494e70b7f77/",
            "js": "default+zh_CN.I.js",
            "css": "default+zh_CN.css",
            "properties": {":JSHash": "fc20d480e134e0dfc60ba494e70b7f77", ":NoOldNames": false, ":Version": "1.0"}
        },
        ":language": {
            "versions": {":1": "1", ":1.0": "1"},
            "path": "/api/language/1.0/a0bd458876c67d6b4272493cc004a8ff/",
            "js": "default+zh_CN.I.js",
            "properties": {":JSHash": "a0bd458876c67d6b4272493cc004a8ff", ":Version": "1.0"}
        },
        ":feeds": {
            "versions": {":1": "1", ":1.0": "1"},
            ...
            "js": "default+zh_CN.I.js",
            "css": "default+zh_CN.css",
            "properties": {":JSHash": "efe8f95c5756111c3e36c06dab50fd12", ":Version": "1.0"}
        },
        ":spreadsheets": {
            "versions": {":0": "1", ":0.4": "1"},
        ...
        ":ima": {
            "versions": {":1": "1", ":1.7": "1"},
            "path": "/api/ima/1.7/9fd415db3bb953707e811e4827fe957b/",
            "js": "default.I.js",
            "properties": {":JSHash": "9fd415db3bb953707e811e4827fe957b", ":Version": "1.7"}
        },
        ":wave": {
            "versions": {":1": "1", ":1.0": "1"},
        ...
        ":annotations": {
            ...
            "js": "default+zh_CN.I.js",
            "properties": {":JSHash": "35a28186b721d9e08b0c0b439b3c55b8", ":Version": "1.0"}
        },
        ":earth": {
            "versions": {":1": "1", ":1.0": "1"},
            "path": "/api/earth/1.0/109c7b2bae7fe6cc34ea875176165d81/",
            "js": "default.I.js",
            "properties": {":JSHash": "109c7b2bae7fe6cc34ea875176165d81", ":Version": "1.0"}
        },
        ":picker": {
            "versions": {":1": "1", ":1.0": "1"},
            "path": "/api/picker/1.0/5f01fa9c8a50be2d0100ffeff28be62b/",
            "js": "default.I.js",
            "css": "default.css",
            "properties": {":JSHash": "5f01fa9c8a50be2d0100ffeff28be62b", ":Version": "1.0"}
        }
    });
    google.loader.rpl({
        ":scriptaculous": {
